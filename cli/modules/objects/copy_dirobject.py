...
class CopyDirObject(object.Object):
    ...
    def difference(self):
        ...
        common.recurse_directories(self._source, self._destination, diff_file, self._ignore_regex)
    ...
    def backup(self):
        ...
        with logger().indent('backup'):
            for destination in destination_to_backup:
                ...
                backup_destination = \
                    os.path.join(backup_dir, os.path.relpath(destination, self._destination))
